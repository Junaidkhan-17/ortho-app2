...
const contactItems = [
  { icon: <EmailIcon sx={{ color: "#fff", fontSize: "0.9rem" }} />, label: "Email", text: "kaustubhkaleorthosurgeon@gmail.com", href: "mailto:kaustubhkaleorthosurgeon@gmail.com" },
  { icon: <PhoneIcon sx={{ color: "#fff", fontSize: "0.9rem" }} />, label: "Phone", text: "+91 9764566676 (M)", href: "tel:+919764566676" },
  { icon: <LocationOnIcon sx={{ color: "#fff", fontSize: "0.9rem" }} />, label: "VIJAYA MULTISPECIALITY HOSPITAL", text: "DeenDayal nagar, Nagpur - 440021", href: "https://maps.app.goo.gl/FG8mHHkC87JxuaF86" },
];
